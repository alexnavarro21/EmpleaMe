            ...
            {(() => {
              ...
              if (!editMode) return (
                <div className="grid grid-cols-2 gap-x-6">
                  <VF label="Nombre de la empresa" value={nombreEmpresa} className="col-span-2" />
                  ...
                  {descripcion && (
                    <div className="col-span-2 mb-4">
                      <p className={`text-xs mb-0.5 ${M}`}>Descripción de la empresa</p>
              ...
              return (
                <div className="grid grid-cols-2 gap-x-6">
                  <FormField label="Nombre de la empresa" placeholder="Ej: Automotriz Salinas" value={nombreEmpresa} onChange={(e) => setNombreEmpresa(e.target.value)} className="col-span-2" />
                  ...
                  <div className="col-span-2 mb-3">
                    ...
                    <textarea rows={4} placeholder="Cuéntales a los estudiantes qué hace tu empresa..." value={descripcion} onChange={(e) => setDescripcion(e.target.value)}
