      ...
      <div className={`min-h-screen font-sans ${isDark ? "bg-[#1e1e1c]" : "bg-white"}`}>
        ...
        <div className="grid md:grid-cols-2 min-h-[calc(100vh-56px)]">
          ...
          <div className={`flex flex-col justify-center px-10 py-16 ${isDark ? "bg-[#02192e]" : "bg-[#042C53]"}`}>
            <span className="inline-block text-xs px-3 py-1 rounded-lg bg-[#185FA5] text-[#B5D4F4] mb-4 w-fit">
              Para estudiantes técnicos
            </span>
            <h1 className="text-[22px] font-medium text-[#E6F1FB] leading-snug mb-3">
              Tu primera práctica laboral está a un paso
            </h1>
            <p className="text-sm text-[#85B7EB] leading-relaxed mb-10">
              ...
              {[
                ...
                <div key={step.n}>
                  <div className="flex items-start gap-4">
                    <div className="w-8 h-8 rounded-full bg-[#185FA5] flex items-center justify-center text-sm font-medium text-[#E6F1FB] flex-shrink-0">
                      {step.n}
                    </div>
                    <div className="pt-1">
                      <p className="text-sm font-medium text-[#E6F1FB] mb-1">{step.title}</p>
                      <p className="text-xs text-[#85B7EB] leading-snug">{step.desc}</p>
                    </div>
                  </div>
                  {i < 2 && (
